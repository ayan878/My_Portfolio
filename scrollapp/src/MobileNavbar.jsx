...
function MobileNavbar() {
  return (
    <div className="fixed top-1/2 right-8 md:right-12 transform -translate-y-1/2 flex flex-col w-7 md:w-10 shadow-2xl bg-purple-900 justify-evenly items-center gap-4 rounded-full">
      <ScrollLink
        to="home"
        spy={true}
        smooth={true}
