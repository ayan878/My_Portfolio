      ...
      <div className="h-40  relative flex items-center overflow-hidden">
        ...
        > */}
          {/* <p
            ...
            // }}
            className="text-base sm:text-sm py-10 font-bold text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300"
          >
            {revealText}
          </p> */}
        {/* </motion.div> */}
        ...
        <div className=" overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
          <p className="text-base sm:text-lg py-10 font-bold bg-clip-text text-transparent bg-[#d8d8e1]">
            {text}
          </p>
          <MemoizedStars />
        </div>
