    ...
    >
      ...
      >
        <img
          src={pic}
          alt="Ayan Raza"
          className="absolute rounded-xl w-full h-full mx-auto lg:mx-0 border-8"
        />
        {/* here extra div is use for dragging cuz dragging through img not working effectively */}
        <div className="absolute bg-transparent w-full h-full cursor-pointer"></div>
      </motion.div>
    </motion.div>
  );
};
