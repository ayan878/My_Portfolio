...
const FloatingNavbar:React.FC=()=> {
  ...
  return (
    <motion.div
      className="fixed top-1/2 right-4 sm:right-8 md:right-12 transform -translate-y-1/2 flex flex-col w-7 sm:w-8 md:w-10 justify-evenly items-center gap-4 rounded-full z-50 shadow-[3px_6px_0px_black]"
      style={{ backgroundColor }}
    >
      <ScrollLink
        to="home"
        ...
        className="text-white p-2 cursor-pointer"
      >
        <FaHome className="text-xs sm:text-base md:text-2xl text-yellow-300" />
      </ScrollLink>
      <ScrollLink
        to="skills"
        spy={true}
        ...
        className="text-white p-2 cursor-pointer"
      >
        <LuBrainCog className="text-xs sm:text-base md:text-2xl text-yellow-300" />
      </ScrollLink>
      <ScrollLink
        to="projects"
        spy={true}
        ...
        className="text-white p-2 cursor-pointer"
      >
        <FaCodeBranch className="text-xs sm:text-base md:text-2xl text-yellow-300" />
      </ScrollLink>
      <ScrollLink
        to="about"
        spy={true}
        ...
        className="text-white p-2 cursor-pointer"
      >
        <FaUser className="text-xs sm:text-base md:text-2xl text-yellow-300" />
      </ScrollLink>
    </motion.div>
  );
}
