...
//               <img src={Logo} alt="logo" className="w-16 h-16 hidden lg:flex" />
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 mb-6">
            ...
            <p className="mt-4 text-sm sm:text-base">
              Subscribe to IslahTV YouTube channel to watch more videos on
              website development and press the bell icon to get immediate
              notification of the latest videos.
            </p>
          </div>
          <div className="w-full sm:w-1/2 lg:w-1/5 mb-6">
            <h2 className="text-xl font-paytone text-yellow-300">Home Town</h2>
          ...
          <div className="w-full sm:w-1/2 lg:w-1/4 mb-6">
            ...
            <form action="#" className="mt-4 flex flex-col sm:flex-row">
              <input
                type="email"
                placeholder="Enter your email id"
                className="p-2 rounded-l bg-gray-700 text-white border-none outline-none mb-4 sm:mb-0 sm:w-3/4"
              />
              <button
                type="submit"
                className="p-2 bg-purple-900 hover:bg-pink-500 rounded-r sm:w-1/4"
              >
                →
              </button>
            </form>
            <div className="mt-4 flex items-center space-x-4 justify-center sm:justify-start">
