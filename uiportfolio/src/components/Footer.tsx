...
// function Footer() {
//   return (
//     <div className="relative h-96 w-full rounded-xl bg-black">
//       <div className="absolute inset-2 grid rounded-xl bg-yellow-300 shadow-lg border-2 border-black transform transform-translate-z-16 translate-y-[-8px]">
//         Hover Me
//       </div>
//     </div>
//   );
